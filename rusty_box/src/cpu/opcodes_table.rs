...
/// The wrapper is type-safe and will work with any `BxCpuC<I, T>` instance.
///
/// # Example
/// ```ignore
...
macro_rules! make_handler_wrapper {
    ($wrapper_name:ident, $handler_fn:path) => {
        ...
        pub(super) fn $wrapper_name<I: $crate::cpu::cpuid::BxCpuIdTrait>(
            cpu: &mut $crate::cpu::BxCpuC<'_, I, T>,
...
pub(super) struct BxOpcodeEntry<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation> {
    /// Handler function for memory form or primary handler
    /// This is a function pointer that will be called with `&mut BxCpuC<I, T>` and `&Instruction`
    pub(super) execute1: fn(&mut BxCpuC<'_, I, T>, &Instruction) -> Result<()>,

    /// Handler function for register form or secondary handler
    /// None if instruction doesn't have a register form
    #[allow(clippy::type_complexity)]
    pub(super) execute2: Option<fn(&mut BxCpuC<'_, I, T>, &Instruction) -> Result<()>>,
...
pub(super) fn get_opcode_entry<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
    opcode: crate::cpu::decoder::Opcode,
) -> Option<BxOpcodeEntry<I, T>> {
    use crate::cpu::decoder::Opcode;

    // Wrapper functions to convert handlers to the correct signature
    fn mov_gd_ed_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
    ...
    fn mov_gd_ed_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ed_gd_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ed_gd_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ed_id_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ed_id_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_eb_gb_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_gb_eb_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_gd_ed_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_gd_ed_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_ed_gd_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_ed_gd_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_eax_id_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_eb_ib_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_ew_ib_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn add_ew_ib_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn sub_gd_ed_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn sub_gd_ed_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn sub_ed_gd_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn sub_ed_gd_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn sub_eax_id_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_gb_eb_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_gb_eb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_eb_gb_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_eb_gb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_gw_ew_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_gw_ew_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_gd_ed_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_gd_ed_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_al_ib_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.cmp_al_ib(instr);
    ...
    fn cmp_ax_iw_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.cmp_ax_iw(instr);
    ...
    fn cmp_eax_id_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_ew_iw_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_ew_iw_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_ed_id_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_ed_id_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn cmp_eb_ib_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn bx_end_trace_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        _instr: &Instruction,
    ) -> Result<()> {
    ...
    fn adc_eb_gb_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn adc_gw_ew_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn adc_ew_gw_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn adc_ed_gd_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn adc_gd_ed_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_al_od_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ax_od_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_od_al_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_od_ax_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_gb_eb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_gb_eb_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_eb_gb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_eb_gb_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_rb_ib_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.mov_rb_ib(instr);
    ...
    fn mov_eb_ib_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_gw_ew_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_gw_ew_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ew_gw_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ew_gw_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_rw_iw_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.mov_rw_iw(instr);
    ...
    fn mov_ew_iw_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn mov_ew_sw_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.mov_ew_sw(instr)?;
    ...
    fn mov_sw_ew_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.mov_sw_ew(instr)?;
    ...
    fn and_eb_gb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn and_gb_eb_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn and_gb_eb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn and_eb_ib_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn or_eb_gb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn or_gb_eb_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn or_gb_eb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn or_eb_ib_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_eb_gb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_gb_eb_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_gb_eb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_eb_ib_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_eb_ib_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn not_eb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.not_eb_m(instr)?;
    ...
    fn test_eb_gb_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn test_eb_ib_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_ed_gd_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_gd_ed_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_gd_ed_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn zero_idiom_gd_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_ew_gw_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_gw_ew_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn xor_gw_ew_m_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn zero_idiom_gw_r_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn in_al_ib_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.in_al_ib(instr)
    ...
    fn in_ax_ib_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.in_ax_ib(instr)
    ...
    fn in_eax_ib_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.in_eax_ib(instr)
    ...
    fn out_ib_al_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.out_ib_al(instr)
    ...
    fn out_ib_ax_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.out_ib_ax(instr)
    ...
    fn out_ib_eax_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn in_al_dx_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.in_al_dx(instr)
    ...
    fn in_ax_dx_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.in_ax_dx(instr)
    ...
    fn in_eax_dx_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.in_eax_dx(instr)
    ...
    fn out_dx_al_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.out_dx_al(instr)
    ...
    fn out_dx_ax_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.out_dx_ax(instr)
    ...
    fn out_dx_eax_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn push_op16_sw_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn pop_op16_sw_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
    ...
    fn push_id_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
        cpu.push_id(instr)?;
    ...
    fn jmpf_ap_wrapper<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation>(
        cpu: &mut BxCpuC<'_, I, T>,
        instr: &Instruction,
    ) -> Result<()> {
