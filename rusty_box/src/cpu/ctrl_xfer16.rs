...
impl<I: BxCpuIdTrait, T: crate::cpu::instrumentation::Instrumentation> BxCpuC<'_, I, T> {
    ...
    pub fn jo_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_of(), new_ip)
    }
    ...
    pub fn jb_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_cf(), new_ip)
    }
    ...
    pub fn jz_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_zf(), new_ip)
    }
    ...
    pub fn jbe_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_cf() || self.get_zf(), new_ip)
    }
    ...
    pub fn js_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_sf(), new_ip)
    }
    ...
    pub fn jp_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_pf(), new_ip)
    }
    ...
    pub fn jl_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_sf() != self.get_of(), new_ip)
    }
    ...
    pub fn jle_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        let ip = self.get_ip();
        let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
        self.conditional_branch16(self.get_zf() || (self.get_sf() != self.get_of()), new_ip)
    }
    ...
    pub fn loop16_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        if as32l {
...

            {
                ...
                let ip = self.get_ip();
                let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
                self.conditional_branch16(count != 0, new_ip)?;
            }
    ...
    pub fn loope16_jb(&mut self, instr: &Instruction) -> super::Result<()> {
        ...
        if as32l {
...

            {
                ...
                let ip = self.get_ip();
                let new_ip = (ip as i32).wrapping_add(disp as i32) as u16;
                self.conditional_branch16(count != 0 && self.get_zf(), new_ip)?;
            }
