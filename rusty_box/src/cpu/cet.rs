...
// CET control MSR bit constants — matches Bochs cet.cc:32-39
...
/// Matches Bochs cet.cc:41-48 is_invalid_cet_control()
...
impl<I: BxCpuIdTrait> BxCpuC<'_, I> {
    // =========================================================================
    // CET query helpers — Bochs cet.cc:50-78
    // =========================================================================

    /// Check if shadow stack is enabled for the given privilege level.
    /// Bochs cet.cc:50-54 ShadowStackEnabled()
    ...
    /// Bochs cet.cc:56-60 ShadowStackWriteEnabled()
    ...
    /// Bochs cet.cc:62-66 EndbranchEnabled()
    ...
    /// Bochs cet.cc:68-72 EndbranchEnabledAndNotSuppressed()
    ...
    /// Bochs cet.cc:74-78 WaitingForEndbranch()
    ...
    // =========================================================================
    // CET tracking helpers — Bochs cet.cc:80-103
    // =========================================================================

    /// Set WAIT_FOR_ENBRANCH flag after an indirect branch.
    /// Bochs cet.cc:80-86 track_indirect()
    ...
    /// Bochs cet.cc:88-96 track_indirect_if_not_suppressed()
    ...
    /// Bochs cet.cc:98-103 reset_endbranch_tracker()
    ...
    /// Bochs cet.cc:105-119 LegacyEndbranchTreatment()
    ...
    // =========================================================================
    // PAUSE instruction handler — Bochs proc_ctrl.cc:76-90
    // =========================================================================

    /// PAUSE handler. Checks VMX/SVM intercepts before executing as no-op hint.
    /// Bochs proc_ctrl.cc:76-90
    pub(super) fn pause(
        &mut self,
        _instr: &crate::cpu::decoder::Instruction,
    ) -> Result<()> {
        // Bochs proc_ctrl.cc:78-81 — VMX PAUSE exit
        if self.in_vmx_guest {
            self.vmexit_pause()?;
        }

        // Bochs proc_ctrl.cc:83-87 — SVM PAUSE intercept
    ...
    /// Bochs vmexit.cc:170-194 VMexit_PAUSE()
    ...
    /// Bochs svm.cc:975-986 SvmInterceptPAUSE()
