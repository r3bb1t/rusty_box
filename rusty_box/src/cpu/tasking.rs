...
impl<I: BxCpuIdTrait> super::cpu::BxCpuC<'_, I> {
    ...
    pub(super) fn task_switch(
        ...
        // Capture old EFLAGS before modification (Bochs tasking.cc:258)
        ...
        if (final_eflags & super::eflags::EFlags::VM.bits()) != 0 {
            ...
            // SS validation (Bochs tasking.cc:624-677)
            ...
            // Restore CPL (Bochs tasking.cc:679)
            self.sregs[BxSegregs::Cs as usize].selector.rpl = save_cpl;

            // DS/ES/FS/GS validation via task_switch_load_selector (Bochs tasking.cc:681-688)
            ...
            // CS validation (Bochs tasking.cc:699-754)
            ...
            // Bochs tasking.cc:756 — updateFetchModeMask() after CS reload
    ...
    /// Based on BX_CPU_C::task_switch_load_selector in tasking.cc:839-885
