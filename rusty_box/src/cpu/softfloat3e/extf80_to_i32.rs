...
pub fn extf80_to_i32(a: floatx80, rounding_mode: u8, exact: bool, status: &mut SoftFloatStatus) -> i32 {
    // Handle unsupported
...
pub fn extf80_to_i32_round_to_zero(a: floatx80, exact: bool, status: &mut SoftFloatStatus) -> i32 {
    ...
    if shift_dist < 33 {
        ...
        if a.sign_exp == pack_to_extf80_sign_exp(true, 0x401E)
            && sig < 0x8000000100000000
        {
