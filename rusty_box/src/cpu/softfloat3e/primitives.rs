...
#[inline]
pub(in crate::cpu) fn short_shift_right_jam64(a: u64, dist: u8) -> u64 {
...
#[inline]
pub(in crate::cpu) fn shift_right_jam32(a: u32, dist: u16) -> u32 {
    if dist < 31 {
...
#[inline]
pub(in crate::cpu) fn shift_right_jam64(a: u64, dist: u32) -> u64 {
    if dist < 63 {
...
#[inline]
pub(in crate::cpu) fn short_shift_left128(a64: u64, a0: u64, dist: u8) -> (u64, u64) {
    debug_assert!((1..=63).contains(&dist));
...
#[inline]
pub(in crate::cpu) fn short_shift_right128(a64: u64, a0: u64, dist: u8) -> (u64, u64) {
    debug_assert!((1..=63).contains(&dist));
    let z64 = a64 >> dist;
...
pub(in crate::cpu) fn shift_right_jam128(a64: u64, a0: u64, dist: u32) -> (u64, u64) {
    if dist < 64 {
        if dist == 0 {
            return (a64, a0);
        }
        let z64 = a64 >> dist;
        let z0 = (a64 << ((!dist).wrapping_add(1) & 63))
            | (a0 >> dist)
        ...
        (
            0,
            (a64 >> d) | ((((a64 << ((!d).wrapping_add(1) & 63)) | a0) != 0) as u64),
        )
    } else {
        (0, ((a64 | a0) != 0) as u64)
    }
...
/// Returns (z128, z64, z0).
pub(in crate::cpu) fn shift_right_jam256(a3: u64, a2: u64, a1: u64, a0: u64, dist: u32) -> (u64, u64, u64, u64) {
    if dist < 64 {
        if dist == 0 {
            return (a3, a2, a1, a0);
        }
...
#[inline]
pub(in crate::cpu) fn count_leading_zeros16(a: u16) -> u8 {
    if a == 0 {
        16
    } else {
        a.leading_zeros() as u8
    }
}

#[inline]
pub(in crate::cpu) fn count_leading_zeros32(a: u32) -> u8 {
    if a == 0 {
        32
    } else {
        a.leading_zeros() as u8
...
#[inline]
pub(in crate::cpu) fn count_leading_zeros64(a: u64) -> u8 {
    if a == 0 {
        64
    } else {
        a.leading_zeros() as u8
...
#[inline]
pub(in crate::cpu) fn add128(a64: u64, a0: u64, b64: u64, b0: u64) -> (u64, u64) {
...
#[inline]
pub(in crate::cpu) fn sub128(a64: u64, a0: u64, b64: u64, b0: u64) -> (u64, u64) {
    let a = ((a64 as u128) << 64) | (a0 as u128);
    let b = ((b64 as u128) << 64) | (b0 as u128);
...
#[inline]
pub(in crate::cpu) fn mul64_to_128(a: u64, b: u64) -> (u64, u64) {
...
#[inline]
pub(in crate::cpu) fn mul64_to_128_add(a: u64, b: u64, c: u64) -> (u64, u64) {
...
#[inline]
pub(in crate::cpu) fn eq128(a64: u64, a0: u64, b64: u64, b0: u64) -> bool {
    (a64 == b64) && (a0 == b0)
}

/// 128-bit comparison: less-than-or-equal (unsigned)
#[inline]
pub(in crate::cpu) fn le128(a64: u64, a0: u64, b64: u64, b0: u64) -> bool {
    (a64 < b64) || ((a64 == b64) && (a0 <= b0))
}

/// 128-bit comparison: less-than (unsigned)
#[inline]
pub(in crate::cpu) fn lt128(a64: u64, a0: u64, b64: u64, b0: u64) -> bool {
    (a64 < b64) || ((a64 == b64) && (a0 < b0))
}
...
#[inline]
pub(in crate::cpu) fn short_shift_right_jam64_extra(a: u64, extra: u64, dist: u8) -> (u64, u64) {
    debug_assert!((1..=63).contains(&dist));
    let v = a >> dist;
...
#[inline]
pub(in crate::cpu) fn mul64_by_shifted32_to128(a: u64, b: u32) -> (u64, u64) {
