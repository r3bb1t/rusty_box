...
pub(crate) fn f32_round_to_int_scaled(
    mut a: float32,
    scale: u8,
    rounding_mode: u8,
    exact: bool,
...
#[inline]
pub(crate) fn f32_round_to_int(a: float32, status: &mut SoftFloatStatus) -> float32 {
...
#[inline]
pub(crate) fn f32_round_to_int_with_scale(
    a: float32,
    scale: u8,
    status: &mut SoftFloatStatus,
) -> float32 {
