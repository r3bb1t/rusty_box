...
fn fp_compare_f32(a: f32, b: f32, imm: u8) -> bool {
    ...
    match imm & 0x1F {
        0 | 8 | 16 | 24 => !unordered && a == b,      // EQ
        1 | 9 | 17 | 25 => !unordered && a < b,        // LT
        2 | 10 | 18 | 26 => !unordered && a <= b,      // LE
        3 | 11 | 19 | 27 => unordered,                  // UNORD
        4 | 12 | 20 | 28 => unordered || a != b,        // NEQ
        5 | 13 | 21 | 29 => unordered || a >= b,        // NLT (GE)
        6 | 14 | 22 | 30 => unordered || a > b,         // NLE (GT)
        7 | 15 | 23 | 31 => !unordered,                 // ORD
        _ => unreachable!(),
    }
}

/// Compare two f64 values per the VCMPPD/VCMPSD predicate encoding.
#[inline]
fn fp_compare_f64(a: f64, b: f64, imm: u8) -> bool {
    let unordered = a.is_nan() || b.is_nan();
    match imm & 0x1F {
        0 | 8 | 16 | 24 => !unordered && a == b,
        1 | 9 | 17 | 25 => !unordered && a < b,
        2 | 10 | 18 | 26 => !unordered && a <= b,
        3 | 11 | 19 | 27 => unordered,
        4 | 12 | 20 | 28 => unordered || a != b,
        5 | 13 | 21 | 29 => unordered || a >= b,
        6 | 14 | 22 | 30 => unordered || a > b,
        7 | 15 | 23 | 31 => !unordered,
        _ => unreachable!(),
    }
}
