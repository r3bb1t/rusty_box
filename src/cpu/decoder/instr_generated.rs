...
impl Debug for OperandData {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "OperandData(Id:{:#x}, Iw:[{:?}], Ib:[{:?}])",
            self.id,
            self.iw(),
            self.ib())
    }
...
impl OperandData {
    ...
    pub fn set_iw(&mut self, val: [u16; 2]) {
        self.id = unsafe { core::mem::transmute(val) };
    }
...
impl Debug for DisplacementData {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "DisplacementData(displ16u:{}, displ32u:{:#x}, Id2:{:#x})",
            self.displ16u(), self.displ32u(), self.id2())
    }
}
...
unsafe impl Send for BxInstructionGenerated {}
unsafe impl Sync for BxInstructionGenerated {}
...
impl BxInstructionGenerated {
    ...
    #[cfg(feature = "x86_64")]
    pub fn iq(&self) -> u64 {
        unsafe { core::mem::transmute(self.modrm_form) }
    }
    ...
    pub fn set_iq(&mut self, val: u64) {
        unsafe {
            self.modrm_form = core::mem::transmute(val);
        }
    }
