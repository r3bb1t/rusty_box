...
pub const fn const_fetch_decode32(bytes: &[u8], is_32: bool) -> DecodeResult<BxInstructionGenerated> {
    let mut instr = BxInstructionGenerated {
        ...
        modrm_form: ModRmForm {
            ...
            displacement: DisplacementData { data32: 0, data16: 0 },
        },
    };
...
const fn get_immediate_size_32(b1: u32, map: u8, os_32: bool) -> u8 {
    if map == 0 {
        ...
        match opcode {
            ...
            0x6A | 0x6B | 0xA8 | 0xB0..=0xB7 | 0xCD | 0xD4 | 0xD5 |
            0xE0..=0xE7 | 0xEB | 0x70..=0x7F |
            ...
            0x68 | 0x69 | 0xA9 | 0xE8 | 0xE9 | 0x81 | 0xC7 |
            0xB8..=0xBF => {
                if os_32 { 4 } else { 2 }
            }
