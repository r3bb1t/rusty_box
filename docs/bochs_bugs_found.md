...
## 1. VPCONFLICTD/Q Off-by-One (simd_int.h:1137-1155)
...
## 2. KSHIFTLW/KSHIFTRW Threshold (avx512_mask16.cc:155-167)
...
## 3. VPSRLQ Shift-by-64 UB (simd_int.h:1340)
...
for VPSRAVQ at simd_int.h:1196 (`> 64` instead of `> 63`).
...
- `xmm_psrlvq` (simd_int.h:1262): `shift > 63` — correct
- `xmm_psravq` (simd_int.h:1196): `shift > 64` — UB at shift==64
